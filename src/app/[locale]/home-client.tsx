  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <section className="relative mx-auto max-w-[1320px] px-6 pb-20 pt-12 md:px-8 md:pb-24 md:pt-14 lg:px-10">
        <div aria-hidden className="pointer-events-none absolute inset-x-0 top-8 mx-auto h-[460px] max-w-[1040px] rounded-full bg-[radial-gradient(circle_at_center,rgba(139,92,246,0.28),rgba(139,92,246,0.10)_36%,transparent_74%)] blur-[92px]" />
        <div aria-hidden className="pointer-events-none absolute left-1/2 top-24 h-[240px] w-[620px] -translate-x-1/2 rounded-full bg-violet-500/14 blur-[78px]" />
        <div aria-hidden className="pointer-events-none absolute inset-x-0 top-[150px] mx-auto h-[320px] max-w-[1180px] rounded-full bg-[radial-gradient(circle_at_center,rgba(168,85,247,0.10),transparent_68%)] blur-[118px]" />
        <FadeIn>
