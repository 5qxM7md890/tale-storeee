        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          ...
          {discordUrl ? (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center justify-center rounded-xl bg-gradient-to-b from-fuchsia-500 via-violet-500 to-violet-600 px-4 py-2 text-sm font-semibold text-white shadow-[0_14px_34px_rgba(139,92,246,0.32)] hover:brightness-105"
            >
              Join Discord
            </a>
          ) : (
