      ...
      {open ? (
        ...
        >
          ...
          <motion.aside
            ...
            className="fixed inset-x-0 bottom-0 top-16 w-full max-w-full border-t border-white/10 bg-[#0b0f14]/98 shadow-2xl backdrop-blur-xl sm:right-0 sm:left-auto sm:max-w-md sm:rounded-tl-2xl sm:border-l"
